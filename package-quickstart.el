...
(setq package-activated-list
      (delete-dups
       (append
        '(reformatter zig-mode yaml-mode compat with-editor which-key wgrep vertico transient standard-themes spinner sly sesman s rg rainbow-mode queue popup parseclj parseedn orderless modus-themes mlscroll dash magit-section git-commit magit lua-mode keychain-environment jarchive janet-mode clojure-mode inf-clojure iedit glsl-mode fennel-mode exec-path-from-shell embark elixir-mode dumb-jump corfu cider)
